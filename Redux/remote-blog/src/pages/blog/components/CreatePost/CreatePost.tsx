    ...
    <form onSubmit={handleSubmit} onReset={handleCancelEditingPost}>
      <div className='mb-6'>
        <label
          ...
          onClick={() => dispatch({ type: 'title/cancels' })}
        >
          Title
        </label>
        <input
      ...
      <div className='mb-6'>
        ...
        <input
          type='datetime-local'
          id='publishDate'
          className={`block w-56 rounded-lg border
          ${
            errorForm?.publishDate
              ? 'border-red-500 bg-red-50 text-red-900 focus:border-red-500  focus:outline-none focus:ring-red-500 '
